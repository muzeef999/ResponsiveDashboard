...
import { BarChart, Bar, ResponsiveContainer, LineChart, CartesianGrid, XAxis, YAxis, Legend, Line, PieChart, Pie, Cell, Sector,} from "recharts";
...
const PieChart3 = () => {
  ...
  const colors = ['#293366', '#7393fa'];

  return (
    <div className='mx-auto' style={{ width: '190px', height: '190px' }}>
      <ResponsiveContainer>
        <PieChart>
          <Pie
            data={piedata}
